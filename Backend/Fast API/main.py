...
async def startup_event():
    ...
    print("=" * 60)
    print("📋 Available at:")
    print("   • API Docs: https://gprs-fastapi.onrender.com/docs")
    print("   • ReDoc: https://gprs-fastapi.onrender.com/redoc")
    print("   • Health: https://gprs-fastapi.onrender.com/health")
    print("=" * 60)
